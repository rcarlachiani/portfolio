...
export const JsIcon: React.FC<Props> = ({ width, height }) => {
    ...
    return(
        ...
        >
            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="Dribbble-Light-Preview" transform="translate(-420.000000, -7479.000000)" fill={darkTheme ? theme.colors.white : theme.colors.black}>
